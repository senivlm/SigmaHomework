...
namespace Task11.Problem1.Logger
{
    public class LogAnalyser
    {
        public string ErrorLogFilePath { get; }
        public string SourceFilePath { get; }
        public LogAnalyser() : this(@"D:\C# projects\SigmaHomework\Task11\Problem1\Logger\ErrorLog.txt",
        ...
        {
            using var writer = new StreamWriter(ErrorLogFilePath, true);
