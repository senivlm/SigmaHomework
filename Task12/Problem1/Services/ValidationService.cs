...
namespace Task12.Problem1.Services
{
    public static class ValidationService
    {
        public static IGoods ValidateGoods(string lineToValidate, Type goodsType)
        {
            ...
            good = good switch
            {
                ...
                Meat => ValidateMeat(lineToValidate),
        ...
        private static (string name, decimal price, decimal weight) ValidateProduct(string productLine)
        {
            ...
            if (!decimal.TryParse(partsOfProductLine[2].Replace('.', ','), out decimal weight))
            {
        ...
        private static Meat ValidateMeat(string meatLine)
        {
        ...
        private static DairyProduct ValidateDairyProduct(string dairyProductLine)
        {
            ...
            if (!int.TryParse(partsOfDairyProductLine[3], out int expirationDate))
            {
