...
namespace Task14.Purchase
{
    public class Buy
    {
        ...
        public double ProductsPurchaseWeight => _goods.Sum(g =>
        {
            if (g.Goods is IWeightableGoods product)
            {
        ...
        public override string ToString()
        {
            return string.Join("-----------------------------------\n", _goods) +
                ...
                $"Weight of purchase: {ProductsPurchaseWeight}\n";
        }
        #endregion
    }
}
