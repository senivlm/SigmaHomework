...
namespace Task7.Products.ProductPriceChanges
{
    public static class PriceWriter
    {
        public static void SetMeatPriceChanges()
        {
            using StreamWriter writer = new StreamWriter(@"D:\C# projects\SigmaHomework\Task7\Products\ProductPriceChanges\MeatPriceChanges.txt", false);
        ...
        public static void SetDairyProductsPriceChanges()
        {
            ...
            using StreamWriter writer = new StreamWriter(@"D:\C# projects\SigmaHomework\Task7\Products\ProductPriceChanges\DairyProductsPriceChanges.txt", false);
